...
public class QMemberTerms extends EntityPathBase<MemberTerms> {
    ...
    private static final long serialVersionUID = 72145076L;
    ...
    public final com.reservation.domain.terms.QTerms terms;
    ...
    public QMemberTerms(Class<? extends MemberTerms> type, PathMetadata metadata, PathInits inits) {
        ...
        this.terms = inits.isInitialized("terms") ? new com.reservation.domain.terms.QTerms(forProperty("terms")) : null;
    }
