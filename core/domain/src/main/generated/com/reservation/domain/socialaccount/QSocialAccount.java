...
public class QSocialAccount extends EntityPathBase<SocialAccount> {
    ...
    private static final long serialVersionUID = -159101481L;
    ...
    public final EnumPath<com.reservation.auth.oauth.enums.SocialLoginProvider> provider = createEnum("provider", com.reservation.auth.oauth.enums.SocialLoginProvider.class);
